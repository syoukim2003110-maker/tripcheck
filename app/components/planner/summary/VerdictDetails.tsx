...
// The evidence behind the verdict (spec v2.1 summary/TripSummaryCard, second
// half): the trip-day stepper, critical-fact coverage, regional coverage, the
// existing-itinerary comparison, comparable alternatives with their
// before/after diff, the assumptions and the other notices.
//
// docs/product.md: "Evidence counts, regional coverage, assumptions and
// counterfactuals remain available under Verdict details. They are not a
// dashboard placed before the itinerary." So this renders under the itinerary
// it explains, next to the things-to-check card. Above it, the disclosure
// alone was 38px of the first viewport on desktop and was hidden outright on
// phones — reachable only through the overflow menu.
