  ...
  return (
    <main className="legal-page">
      ...
      <section>
        ...
        <p>This early product does not yet create user accounts. This policy will be updated before introducing saved trips, sharing, payments or AI processing of itinerary text.</p>
      </section>
