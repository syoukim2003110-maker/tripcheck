  ...
  return (
    <main className="legal-page">
      ...
      <section>
        ...
        <p>If you choose “Field check” for a stop, TripCheck sends only that place name and area to Google Maps Platform. The returned listing may include current opening-hour status, payment options, rating and a small set of attributed Google reviews. TripCheck may send only those returned evidence fields to Claude for a short, structured risk summary. Claude is instructed not to invent missing facts. The rest of your itinerary is not included.</p>
